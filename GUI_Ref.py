...
class StartPage(tk.Frame):
    def __init__(self,parent,controller):
        ...
        top_label = tk.Label(self,text="""Self Improvement Application""", font=XLARGE_FONT,bg="#89CFF0",width=10, height=0).grid(sticky='nsew',row=0,column=0,columnspan=5)
...
class Data_Table_Page(tk.Frame):
    def __init__(self, parent,controller):
        ...
        top_label = tk.Label(self,text="data Table", font=XLARGE_FONT,bg="#89CFF0",width=10, height=0).grid(sticky='nsew',row=0,column=0,columnspan=5)
...
class New_Entry_Page(tk.Frame):
    def __init__(self, parent,controller):
        ...
        top_label = tk.Label(self,text="Submit New Entry", font=XLARGE_FONT,bg="#89CFF0",width=10, height=0).grid(sticky='nsew',row=0,column=0,columnspan=5)
        ...
        self.OutputText = tk.Text(Entry_Frame,width=10,height=20, font=LARGE_FONT)
...
app.geometry("{}x{}".format(int(screensize[0]),int(screensize[1])))
